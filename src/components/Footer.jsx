      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center mb-12">
          ...
          <div className="lg:text-right">
            ...
            <div className="flex items-center bg-white rounded-lg overflow-hidden max-w-md lg:ml-auto">
              ...
              />
              <button className="bg-[#31b56b] text-white text-sm font-semibold px-6 py-3 hover:bg-[#28a05e] transition-colors">
                SUBMIT
              </button>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <Link href="/" className="text-[#31b56b] text-sm hover:underline" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>
                    HOME
                  </Link>
                </li>
                <li>
        ...
        <div className="border-t border-white/10 pt-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            {/* Powered By */}
            <p className="text-gray-500 text-sm" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>
              Powered by <span className="text-[#31b56b]">Webflow</span>, Designed by <span className="text-[#31b56b]">AM Templates</span>
            </p>
          </div>
        </div>
      </div>
