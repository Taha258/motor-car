...
const megaMenuCols = [
  ...
  },
  {
    links: [
      ...
      { label: 'CAR MAKES TEMPLATE', href: '/showroom' },
      { label: 'CAR TYPES TEMPLATE', href: '/showroom' },
      { label: 'CAR CONDITIONS TEMPLATE', href: '/showroom' },
...
export default function Header() {
  ...
  // Sirf Col 2 + Col 3 check karo (template/utility pages)
  // Col 1 mein home/about/showroom hain jo main nav mein already covered hain
  const isPagesActive = megaMenuCols
    .slice(1)
    .flatMap((col) => col.links)
    .some((link) => pathname === link.href);
